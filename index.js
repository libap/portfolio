...
function createProjectsAccueil() { //async function createProjectsAccueil() 
  /* BOUCLE PROJETS */
  var projects = getProjectsData(); //  var projects = await getProjectsData();
  var projectsHTML = "";
    ...
    projectsHTML += `
      ...
      <div class="projects__row slide-in">
        ...
        <div class="projects__row-content zoomable">
          ...
          <!--<a href="detail.html" data-id="${i}" onclick="generateProjectDetailHTML(${i})" class="btn btn--med btn--theme dynamicBgClr">En savoir +</a>-->
...
function generateProjectDetailHTML(projectIndex) {
  ...
  console.log('fonction generateProjectDetailHTML bien executée')
...
function getProjectsData() {
  return new Promise(function (resolve, reject) {
    fetch('data.json')
      ...
      .then(function (data) {
        resolve(data); // Résout la promesse avec les données JSON
      })
