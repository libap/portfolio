...
function createMenuHeader() {
  ...
  for (var i = 0; i < 1; i++) {
    ...
    <button id="btn-retour" data-id-projetAccueil="" class="hidden" onclick="toggleProjectsContent()">
    ...
    projectsHTML += `
      ...
      <div class="projects__row slide-in">
        ...
        <div class="projects__row-content zoomable">
          ...
          <button data-id="${i}" onclick="generateProjectDetailHTML(${i})" class="btn btn--med btn--theme dynamicBgClr">En savoir +</button>
        </div>
      </div>
    `;
  }
